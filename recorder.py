...
from vit_mmodal import Attention

def find_modules(nn_module, module_type):
    # print("modules: ")
    # for module in nn_module.modules():
    #     print(module)
    #     print(isinstance(module, type))
    #     print(type(module), module_type)
    #     print("*" * 10)
...
class Recorder(nn.Module):
    ...
    def forward(self, img):
        ...
        if not self.hook_registered:
            self._register_hook()
            # print(self.hook_registered, "registered hook!")
